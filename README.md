...
| **Raíz** | El paquete de handoff de diseño: [`HANDOFF.md`](HANDOFF.md) con la especificación completa (geometría, tokens, comportamiento), `index.html` como prototipo de referencia en HTML plano y `assets/` con las imágenes y el vídeo del cliente. |
